...
(function() {
  var $, Ansi, CLASS_ANSI, CLASS_BLURRED, CLASS_CURSOR, CLASS_HEADER, CLASS_INPUT, CLASS_OLD_PROMPT, CLASS_PREFIX, CLASS_PROMPT, DEFAULT_INDENT_WIDTH, DEFAULT_PROMPT_CONINUE_LABEL, DEFAULT_PROMPT_LABEL, EMPTY_DIV, EMPTY_SELECTOR, EMPTY_SPAN, ESCAPE_CHAR, ESCAPE_SYNTAX, E_KEYPRESS, HPConsole, JQConsole, KEY_BACKSPACE, KEY_DELETE, KEY_DOWN, KEY_END, KEY_ENTER, KEY_ESC, KEY_HOME, KEY_LEFT, KEY_N, KEY_P, KEY_PAGE_DOWN, KEY_PAGE_UP, KEY_RIGHT, KEY_T, KEY_TAB, KEY_U, KEY_UP, KEY_W, NEWLINE, PROMPT_INPUT_ID, PROMPT_MARKER_ID, STATE_INPUT, STATE_OUTPUT, STATE_PROMPT, spanHtml,
  ...
  HPConsole = (function(_super) {
    __extends(HPConsole, _super);

    function HPConsole(container, header, prompt_label, prompt_continue_label) {
      this.container = container;
      this._HandleChar = __bind(this._HandleChar, this);
      this._HandleKey = __bind(this._HandleKey, this);
      HPConsole.__super__.constructor.call(this, this.container, "Welcome to HotPie\n", "HP> ", ".");
      this.completion_callback = null;
      this.$is_completion = false;
      this.$is_completion_can_end = false;
    }

    HPConsole.prototype.Reset = function() {
      this.completion_callback = null;
      this.EndCompletion();
      return HPConsole.__super__.Reset.apply(this, arguments);
    };

    HPConsole.prototype.BackspaceToBegin = function() {
      var text;
    ...
    HPConsole.prototype.DeleteToEnd = function() {
      var text;
    ...
    HPConsole.prototype._HandleKey = function(event) {
      var key;
      ...
      if (key === KEY_TAB) {
        if (event.shiftKey) {
          if (this.$is_completion) {
            ...
            HPConsole.__super__._HandleKey.apply(this, arguments);
            return;
          }
        } else {
          if (this.$is_completion) {
    ...
    HPConsole.prototype._HandleChar = function(event) {
      HPConsole.__super__._HandleChar.apply(this, arguments);
      if (this.$is_completion) {
        return this.UpdateCompletionMenu();
      }
    };

    HPConsole.prototype.AcceptCompletion = function() {
      var current_text;
    ...
    HPConsole.prototype.GetCompletionItemSelected = function() {
      var items;
    ...
    HPConsole.prototype.GetCompletionItems = function() {
      return $(this.$prompt_completion_input.autocomplete("widget").find("a"));
    };

    HPConsole.prototype.SelectPreviousCompletion = function() {
      var items;
    ...
    HPConsole.prototype.SelectNextCompletion = function() {
      var items;
    ...
    HPConsole.prototype.SelectNthCompletion = function(n) {
      var items;
    ...
    HPConsole.prototype.UpdateCompletionMenu = function() {
    ...
    HPConsole.prototype.SetCompletionCallback = function(completion_callback) {
      return this.completion_callback = completion_callback;
    };

    HPConsole.prototype.SetupCompletion = function(results) {
    ...
    HPConsole.prototype.InsertCompletion = function(text) {
      this._AppendPromptText(text);
      return this.EndCompletion();
    };

    HPConsole.prototype.EndCompletion = function() {
      this.$is_completion = false;
      this.$is_completion_can_end = false;
      this.BreakdownCompletion();
    };

    HPConsole.prototype.ShouldIndent = function() {
      return this.$prompt_left.text().match(/^\s*$/);
    };

    HPConsole.prototype.ShouldDeindent = function() {
  ...
  $.fn.hpconsole = function(header, prompt_main, prompt_continue) {
    return new HPConsole(this, header, prompt_main, prompt_continue);
  };
