...
(function() {
  ...
  HPConsole = (function(_super) {
    ...
    HPConsole.prototype.AcceptCompletion = function() {
      ...
      this._AppendPromptText(current_text);
    ...
    HPConsole.prototype.UpdateCompletionMenu = function() {
      if (this.$prompt_left.text().length < this.$completion_start_idx) {
        this.EndCompletion();
        return;
      }
    ...
    HPConsole.prototype.SetupCompletion = function(results) {
      ...
      return this.$completion_start_idx = this.$prompt_left.text().length;
    };
